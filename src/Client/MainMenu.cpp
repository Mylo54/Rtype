...
rtp::MainMenu::MainMenu(eng::RegistryManager &manager, std::function<int(eng::RegistryManager&, bool, int, int)> &co, eng::GraphicSystems &gfx) : _manager(manager), _singlePlayerBtnFct(co), _gfx(gfx)
{
